...
from .quantum_networks import quantum_feature_extraction, local_qmp_layer, local_qmp_layer_gamma_zero
...
class NISQQGCNConv_gammazero(MessagePassing):
    """
    A Pure NISQ-compatible Quantum Graph Convolutional Network layer.
    """
    def __init__(self, in_channels, q_depth=1):
        ...
        self.local_mp = local_qmp_layer_gamma_zero(self.n_qubits)
